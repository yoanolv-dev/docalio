...
export const MOCK_WORKSPACES: WorkspaceListItem[] = [
  { id: "w1", organization_id: ORG, name: "Boulangerie Margot", client_company: "Boulangerie Margot", client_email: "contact@margot.fr", client_phone: null, status: "active", internal_note: null, logo_url: null, primary_color: null, created_by: null, created_at: daysAgo(30), updated_at: daysAgo(2), documentCount: 7, visibleCount: 6, hasActiveLink: true, pendingDecisions: 2, lastActivityAt: daysAgo(0) },
