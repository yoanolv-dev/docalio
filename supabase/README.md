...
| `migrations/20260611300000_document_decisions.sql` | Table `document_decisions` (validation / refus / modification par le client), RLS lecture par les membres de l'org, RPC publiques `SECURITY DEFINER` `submit_document_decision` et `get_portal_decisions` (validées par token). |
